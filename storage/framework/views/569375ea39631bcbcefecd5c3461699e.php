...
?>
<?php if($activeBanners->count() > 0): ?>
<div class="relative w-full h-[80vh] min-h-[500px] overflow-hidden group mb-16">
    <div id="banner-carousel" class="w-full h-full">
        <?php $__currentLoopData = $activeBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
