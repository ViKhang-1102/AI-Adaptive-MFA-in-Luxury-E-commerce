    ...
    <div class="max-w-xl w-full space-y-8 bg-white p-10 rounded-xl shadow-lg border-t-4 border-blue-500">
        <div class="text-center">
            ...
            <p class="text-sm text-gray-600 mb-6">
                Your payment for order <span class="font-bold text-gray-900">#<?php echo e($order->order_number); ?></span> has been processed securely.
            </p>
        </div>
        ...
        <div class="bg-gray-50 rounded-lg p-6 space-y-4 border border-gray-100">
            ...
            <div class="flex justify-between items-center text-sm">
                ...
                <span class="font-bold text-gray-900 text-lg">
                    $<?php echo e(number_format($order->total_amount, 2)); ?> <?php echo e(env('PAYPAL_CURRENCY', 'USD')); ?>

                </span>
            </div>
            
            <div class="flex justify-between items-center text-sm pt-2">
                <span class="text-gray-500"><i class="fas fa-building mr-2"></i>Platform Fee (<?php echo e($adminPercentage ?? '10'); ?>%)</span>
                <span class="text-gray-700">$<?php echo e(number_format($adminFee, 2)); ?> <?php echo e(env('PAYPAL_CURRENCY', 'USD')); ?></span>
            </div>
            ...
            <div class="flex justify-between items-center text-sm pt-2 border-t mt-2">
                ...
                <span class="text-gray-700">$<?php echo e(number_format($sellerAmount, 2)); ?> <?php echo e(env('PAYPAL_CURRENCY', 'USD')); ?></span>
            </div>
            
            <div class="flex justify-between items-center text-xs text-gray-400 pt-4 mt-2">
                <span>Seller PayPal</span>
                <span><?php echo e($sellerPayPalEmail ?? 'Not Provided'); ?></span>
            </div>
        </div>

        <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(route('orders.show', $order)); ?>" class="flex-1 flex justify-center items-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-sm transition-colors duration-200">
                View Order Details
            </a>
            <a href="<?php echo e(route('home')); ?>" class="flex-1 flex justify-center items-center py-3 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-colors duration-200">
                Back to Home
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\E-commerce2026\resources\views/paypal/success.blade.php ENDPATH**/ ?>