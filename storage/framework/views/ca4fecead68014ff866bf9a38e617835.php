                    ...
                    <div class="relative" id="user-menu-container">
                        ...
                        <div id="user-menu-dropdown" class="absolute right-0 mt-3 w-64 bg-white rounded-md-2xl shadow-sm-hover border border-neutral-100 hidden z-50 overflow-hidden transform opacity-0 scale-95 transition-all duration-200 origin-top-right">
                            ...
                            <div class="p-2">
                                ...
                                <a href="<?php echo e(route('payments.history')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-sm text-neutral-700 hover:bg-neutral-50 hover:text-primary rounded-md-xl transition-colors">
...
<?php endif; ?>
<?php endif; ?><?php /**PATH C:\laragon\www\E-commerce2026 - Copy (6)\resources\views/layouts/header.blade.php ENDPATH**/ ?>