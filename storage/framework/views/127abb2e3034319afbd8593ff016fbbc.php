...
<div class="max-w-7xl mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex gap-2">
            <select id="status-filter" class="px-4 py-2 border rounded-md" onchange="window.location.href = '<?php echo e(route('seller.orders.index')); ?>?status=' + this.value">
                    ...
                    <tr class="border-b hover:bg-neutral-50">
                        ...
                        <td class="px-6 py-3">
                            <div class="flex gap-2 flex-wrap">
                                ...
                                <?php endif; ?>
                                <?php if(in_array($order->status, ['pending', 'confirmed', 'processing', 'paid'])): ?>
