...
<div class="max-w-2xl mx-auto px-4 py-8">
    ...
    <div class="bg-white p-6 rounded-md-lg shadow-sm">
        <form action="<?php echo e(route('admin.customers.update', $user)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\E-commerce2026\resources\views/admin/customers/edit.blade.php ENDPATH**/ ?>