...
<div class="max-w-2xl mx-auto px-4 py-8">
    <a href="<?php echo e(route('admin.banners.index')); ?>" class="text-primary hover:underline mb-4 inline-block">← Back</a>
        ...
        <form action="<?php echo e(route('admin.banners.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" value="<?php echo e(old('title')); ?>"
                    class="w-full px-4 py-2 border rounded-md <?php $__errorArgs = ['title'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="file" name="image" accept="image/*"
                    class="w-full px-4 py-2 border rounded-md <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex gap-4">
                ...
                <a href="<?php echo e(route('admin.banners.index')); ?>" class="px-6 py-2 bg-neutral-500 text-white rounded-md hover:bg-gray-600 font-semibold">
                    Cancel
                </a>
            </div>
        </form>
