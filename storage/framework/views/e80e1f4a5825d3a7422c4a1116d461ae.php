...
<div class="max-w-2xl mx-auto px-4 py-8">
    <a href="<?php echo e(route('admin.customers.index')); ?>" class="text-blue-600 hover:underline mb-4 inline-block">← Back</a>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_confirmation"
                    class="w-full px-4 py-2 border rounded <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex gap-4">
                ...
                <a href="<?php echo e(route('admin.customers.index')); ?>" class="px-6 py-2 bg-gray-500 text-white rounded hover:bg-gray-600 font-semibold">
                    Cancel
                </a>
            </div>
        </form>
