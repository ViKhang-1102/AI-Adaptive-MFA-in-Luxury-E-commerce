                    ...
                    <div class="rounded-lg border border-neutral-200 bg-white p-4">
                        ...
                        <div id="identity-profile-content" class="hidden mt-4 transition-all duration-300">
                            <?php if($order->customer && $order->customer->identity_image): ?>
                                <img src="<?php echo e(asset('storage/' . $order->customer->identity_image)); ?>" class="w-full h-64 object-contain bg-neutral-50 rounded-md" alt="Identity Image">
                            <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\E-commerce2026 - Copy (2)\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>