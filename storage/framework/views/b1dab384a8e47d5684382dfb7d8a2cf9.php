...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="bg-white p-6 rounded-md-lg shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <a href="<?php echo e(route('admin.orders.pending')); ?>" class="p-4 border rounded-md hover:bg-neutral-50 flex items-center justify-between group">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\E-commerce2026 - Copy\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>