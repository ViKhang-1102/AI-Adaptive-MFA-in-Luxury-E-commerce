...
<div class="max-w-2xl mx-auto px-4 py-8">
    <a href="<?php echo e(route('admin.categories.index')); ?>" class="text-blue-600 hover:underline mb-4 inline-block">← Back</a>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex gap-4">
                ...
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="px-6 py-2 bg-gray-500 text-white rounded hover:bg-gray-600 font-semibold">
                    Cancel
                </a>
            </div>
        </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\E-commerce2026\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>