<?php $__env->startSection('title', 'Review Your Order'); ?>
    ...
    <div class="max-w-2xl w-full space-y-8 bg-white p-10 rounded-xl shadow-lg border-t-4 border-blue-600">
        ...
        <div class="bg-gray-50 rounded-lg p-6 space-y-4 border border-gray-200">
            <div class="flex justify-between items-center border-b pb-4">
                <div>
                    <h3 class="text-lg font-bold text-gray-800">Invoice #<?php echo e($order->order_number); ?></h3>
                    <p class="text-xs text-gray-400">Date: <?php echo e($order->created_at->format('M d, Y')); ?></p>
                </div>
            ...
            <div class="space-y-3 mt-4">
                ...
                <div class="flex justify-between items-center text-sm">
                    <div class="flex items-center space-x-3">
                        <span class="text-gray-900 font-medium"><?php echo e($item->product_name); ?></span>
                        <span class="text-gray-400">x<?php echo e($item->quantity); ?></span>
                    </div>
                    <span class="text-gray-700 font-semibold">$<?php echo e(number_format($item->subtotal, 2)); ?></span>
                </div>
            ...
            <div class="border-t pt-4 space-y-2 mt-4">
                ...
                <div class="flex justify-between items-center text-sm">
                    ...
                    <span class="text-gray-700">$<?php echo e(number_format($order->shipping_fee, 2)); ?></span>
                </div>
        ...
        <div class="flex flex-col items-center justify-center p-6 bg-blue-50 rounded-lg border-2 border-dashed border-blue-200">
            ...
            <div class="bg-white p-4 rounded-xl shadow-inner border border-blue-100">
                <img src="<?php echo e($qrCodeUrl); ?>" alt="Payment QR Code" class="w-48 h-48">
            </div>
        ...
        <div class="mt-8 space-y-4">
            <form action="<?php echo e(route('paypal.capture', $order)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="token" value="<?php echo e($token); ?>">
                <input type="hidden" name="PayerID" value="<?php echo e($payerID); ?>">
            ...
            <div class="flex justify-center">
                <a href="<?php echo e(route('paypal.cancel', ['order_id' => $order->id])); ?>" class="text-sm text-gray-400 hover:text-red-500 transition-colors duration-200 underline">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\E-commerce2026\resources\views/paypal/review.blade.php ENDPATH**/ ?>