                    ...
                    <?php if($order && $order->status === 'review'): ?>
                        <div class="mb-8 p-6 bg-amber-50 border border-amber-100 rounded-xl shadow-sm">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <form action="<?php echo e(route('support.order.cancel', $order)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to cancel this order and move items back to your cart?')">
                                    <?php echo csrf_field(); ?>
