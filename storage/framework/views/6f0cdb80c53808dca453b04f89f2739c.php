...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-purple-100 p-6 rounded-lg shadow">
            <div class="text-2xl font-bold text-purple-600">₫<?php echo e(number_format($totalRevenue, 0)); ?></div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <a href="<?php echo e(route('seller.wallet')); ?>" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
