...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
        <div>
            ...
            <p class="text-neutral-500">Welcome back, <?php echo e(auth()->user()->name); ?>. Here is what's happening today.</p>
        </div>
        <div class="flex items-center gap-4">
            <form method="GET" action="<?php echo e(route('seller.dashboard')); ?>" class="flex gap-2 items-center bg-white p-2 rounded-xl border border-neutral-100 shadow-sm">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-soft border border-neutral-100 flex items-center justify-between group hover:border-gold/50 transition-colors">
            <div>
                ...
                <div class="text-3xl font-bold text-primary group-hover:text-gold transition-colors"><?php echo e($totalProducts); ?></div>
            </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-soft border border-neutral-100 flex items-center justify-between group hover:border-gold/50 transition-colors">
            <div>
                <div class="flex items-center gap-2 mb-1">
                    ...
                    <span class="px-2 py-0.5 bg-green-50 text-green-600 text-[10px] font-bold rounded-full border border-green-100">+<?php echo e($todayOrders); ?> today</span>
                </div>
                <div class="text-3xl font-bold text-primary group-hover:text-gold transition-colors"><?php echo e($totalOrders); ?></div>
            </div>
        ...
        <div class="bg-primary p-6 rounded-2xl shadow-hover flex items-center justify-between relative overflow-hidden group">
            ...
            <div class="relative z-10">
                <div class="flex items-center gap-2 mb-1">
                    ...
                    <span class="px-2 py-0.5 bg-gold/20 text-gold text-[10px] font-bold rounded-full border border-gold/20">+$<?php echo e(number_format($todayRevenue, 2)); ?> today</span>
                </div>
                <div class="text-3xl font-bold text-gold">$<?php echo e(number_format($totalRevenue, 2)); ?></div>
            </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-soft border border-neutral-100 flex items-center justify-between group hover:border-gold/50 transition-colors">
            <div>
                ...
                <div class="text-3xl font-bold text-orange-500"><?php echo e($pendingOrders); ?></div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        <a href="<?php echo e(route('seller.products.create')); ?>" class="bg-white p-6 rounded-2xl border border-neutral-100 shadow-soft hover:shadow-hover hover:-translate-y-1 transition-all group flex flex-col items-center text-center">
        ...
        <a href="<?php echo e(route('seller.orders.index')); ?>" class="bg-white p-6 rounded-2xl border border-neutral-100 shadow-soft hover:shadow-hover hover:-translate-y-1 transition-all group flex flex-col items-center text-center">
        ...
        <a href="<?php echo e(route('seller.wallet')); ?>" class="bg-white p-6 rounded-2xl border border-neutral-100 shadow-soft hover:shadow-hover hover:-translate-y-1 transition-all group flex flex-col items-center text-center">
        ...
        <a href="<?php echo e(route('seller.messages.index')); ?>" class="bg-white p-6 rounded-2xl border border-neutral-100 shadow-soft hover:shadow-hover hover:-translate-y-1 transition-all group flex flex-col items-center text-center relative">
            <div class="w-14 h-14 bg-primary-light/5 text-primary rounded-full flex items-center justify-center mb-4 group-hover:bg-primary group-hover:text-white transition-colors">
            ...
            <?php if(isset($unreadMessages) && $unreadMessages > 0): ?>
                <span class="absolute top-4 right-4 bg-red-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-sm"><?php echo e($unreadMessages); ?> new</span>
            <?php endif; ?>
        </a>
    </div>
    ...
    <div class="bg-white p-8 rounded-2xl shadow-soft border border-neutral-100">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="<?php echo e(route('seller.products.index')); ?>" class="flex items-center p-4 border border-neutral-100 rounded-xl hover:bg-neutral-50 hover:border-gold/50 transition-colors group">
            ...
            <a href="<?php echo e(route('orders.index')); ?>" class="flex items-center p-4 border border-neutral-100 rounded-xl bg-primary/5 hover:bg-primary/10 hover:border-gold/50 transition-colors group">
            ...
            <a href="<?php echo e(route('seller.categories.index')); ?>" class="flex items-center p-4 border border-neutral-100 rounded-xl hover:bg-neutral-50 hover:border-gold/50 transition-colors group">
            ...
            <a href="<?php echo e(route('seller.orders.index')); ?>" class="flex items-center p-4 border border-neutral-100 rounded-xl hover:bg-neutral-50 hover:border-gold/50 transition-colors group">
            ...
            <a href="<?php echo e(route('seller.wallet')); ?>" class="flex items-center p-4 border border-neutral-100 rounded-xl hover:bg-neutral-50 hover:border-gold/50 transition-colors group">
            ...
            <a href="<?php echo e(route('profile.show')); ?>" class="flex items-center p-4 border border-neutral-100 rounded-xl hover:bg-neutral-50 hover:border-gold/50 transition-colors group">
