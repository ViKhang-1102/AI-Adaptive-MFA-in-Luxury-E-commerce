...
<div class="max-w-4xl mx-auto px-4 py-12">
    ...
    <div class="mb-8">
        <a href="<?php echo e(url()->previous() == url()->current() ? route('home') : url()->previous()); ?>" class="inline-flex items-center text-sm font-medium text-neutral-500 hover:text-primary transition-colors group">
        ...
        <div class="p-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        ...
                        <div class="bg-primary rounded-xl p-6 text-white shadow-lg mb-8">
                            ...
                            <div class="space-y-3 text-sm border-t border-white/10 pt-4">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-mono"><?php echo e($order->order_number); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-white/60">Status</span>
                                    <span class="px-2 py-0.5 bg-gold/20 text-gold rounded text-[10px] font-bold uppercase tracking-wider"><?php echo e($order->status); ?></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-white/60">Total Amount</span>
                                    <span class="font-bold">$<?php echo e(number_format($order->total_amount, 2)); ?></span>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                ...
                <div class="lg:col-span-2">
                    ...
                    <?php if($order && $order->status === 'review'): ?>
                    ...
                    <form method="POST" action="<?php echo e(route('support.contact.submit')); ?>" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" id="subject" name="subject" 
                                value="<?php echo e(old('subject', $order && $order->status === 'review' ? 'Verification Request: Order #' . $order->order_number : '')); ?>" 
...
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-[10px] mt-1 font-bold uppercase tracking-wider"><?php echo e($message); ?></p><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if($order && isset($messages) && $messages->isNotEmpty()): ?>
                            ...
                            <div id="support-messages-list" class="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                                <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex <?php echo e($msg->sender_id === Auth::id() ? 'justify-end' : 'justify-start'); ?>">
                                        <div class="max-w-[80%] <?php echo e($msg->sender_id === Auth::id() ? 'bg-primary text-white rounded-l-2xl rounded-tr-2xl' : 'bg-neutral-100 text-neutral-800 rounded-r-2xl rounded-tl-2xl'); ?> p-4 shadow-sm">
                                            <p class="text-xs <?php echo e($msg->sender_id === Auth::id() ? 'text-white/60' : 'text-neutral-500'); ?> mb-1">
                                                <?php echo e($msg->sender->name); ?> • <?php echo e($msg->created_at->format('H:i, M d')); ?>
...
<script>
    function useTemplate(type) {
        ...
        const orderNum = "<?php echo e($order->order_number ?? ''); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\E-commerce2026 - Copy\resources\views/support/contact.blade.php ENDPATH**/ ?>