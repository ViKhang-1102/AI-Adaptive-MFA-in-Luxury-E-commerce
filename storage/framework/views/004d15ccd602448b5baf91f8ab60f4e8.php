...
<div class="max-w-7xl mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="<?php echo e(route('admin.customers.create')); ?>" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 font-semibold">
    ...
    <div class="bg-white p-6 rounded-lg shadow mb-6">
        <form method="GET" action="<?php echo e(route('admin.customers.index')); ?>" class="flex gap-4">
            <input type="text" name="search" placeholder="Search by name or email" class="flex-1 px-4 py-2 border rounded" value="<?php echo e(request('search')); ?>">
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-3 flex gap-2">
                            <a href="<?php echo e(route('admin.customers.edit', $customer)); ?>" class="px-3 py-1 bg-blue-600 text-white rounded hover:bg-blue-700 text-sm font-semibold">
