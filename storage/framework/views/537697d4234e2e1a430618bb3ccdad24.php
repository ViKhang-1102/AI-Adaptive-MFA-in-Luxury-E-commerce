...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <div class="flex items-center gap-4">
                ...
                <?php if($order->status === 'review'): ?>
                    <div class="ml-4">
                        <a href="<?php echo e(route('support.contact', ['order_id' => $order->id])); ?>" class="inline-flex items-center gap-2 px-3 py-1 bg-orange-600 text-white rounded-full text-xs font-semibold hover:bg-orange-700 transition">
        ...
        <div>
            <form action="<?php echo e(route('paypal.create', $order)); ?>" method="GET" class="inline">
        ...
        <?php elseif($order->status === 'verified_by_admin' && $order->payment_method === 'online' && in_array($order->payment_status, ['unpaid', 'pending'])): ?>
        <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\E-commerce2026 - Copy\resources\views/orders/show.blade.php ENDPATH**/ ?>