...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="mb-8 flex items-center justify-between">
        <a href="<?php echo e(route('products.index')); ?>" class="inline-flex items-center text-sm font-medium text-neutral-500 hover:text-primary transition-colors group">
            <i data-lucide="arrow-left" class="w-4 h-4 mr-2 group-hover:-translate-x-1 transition-transform"></i>
            Back to Collections
        </a>
        
        <div class="flex items-center gap-2 text-xs font-medium text-neutral-400">
            <a href="<?php echo e(route('home')); ?>" class="hover:text-primary">Home</a>
            <i data-lucide="chevron-right" class="w-3 h-3"></i>
            <a href="<?php echo e(route('products.index')); ?>" class="hover:text-primary">Products</a>
            <i data-lucide="chevron-right" class="w-3 h-3"></i>
            <span class="text-neutral-900"><?php echo e($product->name); ?></span>
        </div>
    </div>
        ...
        <div class="md:col-span-2">
            ...
            <div class="space-y-4 mb-8">
                <div class="flex gap-4 items-center mb-6">
                    ...
                    <div class="relative">
                        <input type="number" id="quantity" name="quantity" value="1" min="1" max="<?php echo e($product->stock); ?>" class="w-24 px-4 py-2 bg-transparent border-0 border-b-2 border-gold focus:ring-0 focus:border-primary text-center font-bold text-lg transition-colors">
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <form action="<?php echo e(route('checkout')); ?>" method="GET" class="w-full">
                        <input type="hidden" name="product_id" value="<?php echo e($product->id); ?>">
                    ...
                    <form action="<?php echo e(route('wishlist.remove', $product->id)); ?>" method="POST" class="w-full">
                        <?php echo csrf_field(); ?>
                    ...
                    <?php else: ?>
                    <form action="<?php echo e(route('wishlist.add', $product->id)); ?>" method="POST" class="w-full">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\E-commerce2026 - Copy\resources\views/products/show.blade.php ENDPATH**/ ?>