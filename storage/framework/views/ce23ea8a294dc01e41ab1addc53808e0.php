...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <form id="cart-form" action="<?php echo e(route('checkout')); ?>" method="GET">
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                <td class="px-6 py-4">
                                    <input type="checkbox" name="item_ids[]" value="<?php echo e($item->id); ?>" class="item-checkbox" checked>
                                </td>
                                <td class="px-6 py-4 flex items-center">
                                    <a href="<?php echo e(route('products.show', $item->product)); ?>" class="flex items-center text-decoration-none hover:text-blue-600">
                                        <?php if($item->product->images->first()): ?>
                                        <img src="<?php echo e(asset('storage/' . $item->product->images->first()->image)); ?>" class="w-16 h-16 rounded mr-4 object-cover">
                                        <?php endif; ?>
                                        <div>
                                ...
                                <td class="px-6 py-4">
                                    <form action="<?php echo e(route('cart.update', $item)); ?>" method="POST" class="flex justify-center">
                                        <?php echo csrf_field(); ?>
                                        <input type="number" name="quantity" value="<?php echo e($item->quantity); ?>" min="1" max="<?php echo e($item->product->stock); ?>" class="w-16 px-2 py-1 border rounded">
        ...
        <div class="bg-white rounded-lg shadow p-6 h-fit">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="block w-full text-center border-2 border-gray-300 text-gray-700 py-2 mt-3 rounded hover:bg-gray-50">
                Continue Shopping
            </a>
        </div>
    </div>
