                ...
                <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                    <?php if($product->hasDiscount()): ?>
                        <div class="flex items-center gap-3">
                            <span class="text-3xl font-bold text-red-600">$<?php echo e(number_format($product->getDiscountedPrice(), 2)); ?></span>
                    ...
                    <?php else: ?>
                        <div class="text-3xl font-bold">$<?php echo e(number_format($product->price, 2)); ?></div>
                    <?php endif; ?>
                </div>
