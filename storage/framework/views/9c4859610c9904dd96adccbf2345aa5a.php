...
<div class="max-w-2xl mx-auto px-4 py-8">
    <div class="mb-6">
        <a href="<?php echo e(route('seller.products.index')); ?>" class="inline-flex items-center text-sm font-medium text-neutral-500 hover:text-primary transition-colors group">
    ...
    <div class="bg-white p-6 rounded-md-lg shadow-sm">
        <form action="<?php echo e(route('seller.products.update', $product)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="name" name="name" class="w-full px-4 py-2 border border-neutral-200 rounded-md-lg focus:ring-2 focus:ring-gold focus:border-transparent <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <textarea id="description" name="description" rows="5" class="w-full px-4 py-2 border border-neutral-200 rounded-md-lg focus:ring-2 focus:ring-gold focus:border-transparent <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <select id="category_id" name="category_id" class="w-full px-4 py-2 border border-neutral-200 rounded-md-lg focus:ring-2 focus:ring-gold focus:border-transparent <?php $__errorArgs = ['category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="number" id="price" name="price" step="any" min="1" max="999999999" 
                        class="w-full px-4 py-2 border border-neutral-200 rounded-md-lg focus:ring-2 focus:ring-gold focus:border-transparent <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                        value="<?php echo e(old('price', $product->price)); ?>" placeholder="Enter USD price" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" id="stock" name="stock" min="0" class="w-full px-4 py-2 border border-neutral-200 rounded-md-lg focus:ring-2 focus:ring-gold focus:border-transparent <?php $__errorArgs = ['stock'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
            ...
            <div class="grid grid-cols-3 gap-4 mb-6">
                <div>
                    ...
                    <input type="number" id="discount_percent" name="discount_percent" min="1" max="100" 
                        class="w-full px-4 py-2 border border-neutral-200 rounded-md-lg focus:ring-2 focus:ring-gold focus:border-transparent <?php $__errorArgs = ['discount_percent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" id="discount_start_date" name="discount_start_date" 
                        class="w-full px-4 py-2 border border-neutral-200 rounded-md-lg focus:ring-2 focus:ring-gold focus:border-transparent <?php $__errorArgs = ['discount_start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" id="discount_end_date" name="discount_end_date" 
                        class="w-full px-4 py-2 border border-neutral-200 rounded-md-lg focus:ring-2 focus:ring-gold focus:border-transparent <?php $__errorArgs = ['discount_end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <div class="relative bg-neutral-100 rounded-md-lg overflow-hidden" style="aspect-ratio: 1;">
                        ...
                        <button type="button" 
                            onclick="if(confirm('Delete this image?')) { document.getElementById('delete-image-form').action = '<?php echo e(route('seller.products.deleteImage', $image)); ?>'; document.getElementById('delete-image-form').submit(); }"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex gap-4">
                ...
                <a href="<?php echo e(route('seller.products.index')); ?>" class="flex-1 px-6 py-2 bg-neutral-500 text-white rounded-md-lg hover:bg-gray-600 transition text-center">
                    Cancel
                </a>
            </div>
        </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\E-commerce2026 - Copy\resources\views/seller/products/edit.blade.php ENDPATH**/ ?>