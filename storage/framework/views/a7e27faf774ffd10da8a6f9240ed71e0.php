...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="bg-white p-6 rounded-lg shadow text-center">
        ...
        <a href="<?php echo e(route('products.index')); ?>" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 mt-4 inline-block">
            Start Shopping
        </a>
    </div>
    <?php else: ?>
    <div class="space-y-4">
        ...
        <a href="<?php echo e(route('customer.messages.conversation', ['product' => $conv['product']->id, 'other' => $conv['seller']->id])); ?>"
           class="block bg-white p-4 rounded-lg shadow hover:bg-gray-50 flex justify-between items-center">
            <div>
                <div class="font-semibold"><?php echo e($conv['product']->name); ?></div>
                <div class="text-sm text-gray-600">Seller: <?php echo e($conv['seller']->name); ?></div>
                <div class="text-sm text-gray-500 truncate" style="max-width:500px;"><?php echo e($conv['last_message']); ?></div>
            </div>
            <?php if($conv['unread_count'] > 0): ?>
            <span class="bg-red-600 text-white rounded-full px-2 py-1 text-xs"><?php echo e($conv['unread_count']); ?></span>
            <?php endif; ?>
        </a>
