...
<div class="max-w-7xl mx-auto px-4 py-8">
    <div class="mb-6">
        <a href="<?php echo e(route('profile.show')); ?>" class="inline-flex items-center text-sm font-medium text-neutral-500 hover:text-primary transition-colors group">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-soft border border-neutral-100 h-fit">
            ...
            <form action="<?php echo e(route('addresses.store')); ?>" method="POST" onsubmit="return validateAddressForm(event)" class="space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-soft border border-neutral-100 hover:shadow-md transition-shadow relative overflow-hidden">
                    ...
                    <div class="flex items-start gap-4">
                        <div class="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center flex-shrink-0">
                            <i data-lucide="<?php echo e($address->label === 'Home' ? 'home' : ($address->label === 'Office' ? 'briefcase' : 'map-pin')); ?>" class="w-6 h-6 text-primary"></i>
                        </div>
                        <div class="flex-1">
                            <h3 class="font-serif font-bold text-lg text-primary mb-1"><?php echo e($address->label ?? 'Address'); ?></h3>
                            <div class="space-y-1 text-sm text-neutral-600 mb-4">
                                <p><strong class="text-neutral-800"><?php echo e($address->recipient_name); ?></strong> &bull; <?php echo e($address->recipient_phone); ?></p>
                                <p class="leading-relaxed"><?php echo e($address->address); ?></p>
                            </div>

                            <div class="flex items-center gap-3 pt-4 border-t border-neutral-100">
                                <button type="button" class="text-sm font-bold text-neutral-600 hover:text-primary transition-colors flex items-center gap-1 edit-address-btn" data-id="<?php echo e($address->id); ?>">
