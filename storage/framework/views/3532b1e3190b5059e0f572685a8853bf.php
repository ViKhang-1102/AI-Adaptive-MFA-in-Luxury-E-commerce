...
<div class="max-w-4xl mx-auto py-8">
    <div class="mb-6">
        <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-blue-600 hover:underline">← Back to Orders</a>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <p class="font-semibold text-lg"><?php echo e(number_format($order->total_amount)); ?>₫</p>
                </div>
                <div>
                    ...
                    ?>
                    <span class="px-3 py-1 rounded-full text-sm font-semibold <?php echo e($paymentClass); ?>">
                            ...
                            <td class="px-4 py-2">
                                <div class="flex items-center gap-3">
                                    <?php if($item->product && $item->product->image): ?>
                                        <img src="<?php echo e(asset($item->product->image)); ?>" alt="<?php echo e($item->product->name); ?>" class="w-12 h-12 object-cover rounded">
                                    <?php else: ?>
                                        <div class="w-12 h-12 bg-gray-200 rounded"></div>
                                    <?php endif; ?>
                                    <div>
                                        <p class="font-semibold"><?php echo e($item->product->name ?? 'Product Removed'); ?></p>
                                        <p class="text-gray-600 text-xs">SKU: <?php echo e($item->product->sku ?? 'N/A'); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 py-2 text-center"><?php echo e($item->quantity); ?></td>
                            <td class="px-4 py-2 text-right"><?php echo e(number_format($item->price)); ?>₫</td>
                            <td class="px-4 py-2 text-right font-semibold"><?php echo e(number_format($item->price * $item->quantity)); ?>₫</td>
                        </tr>
        ...
        <div class="bg-gray-50 rounded-lg p-4">
            <div class="flex justify-between mb-2">
                <span>Subtotal:</span>
                <span><?php echo e(number_format($order->items->sum(fn($item) => $item->price * $item->quantity))); ?>₫</span>
            </div>
            <?php if($order->shipping_fee): ?>
            <div class="flex justify-between mb-2">
                <span>Shipping Fee:</span>
                <span><?php echo e(number_format($order->shipping_fee)); ?>₫</span>
            </div>
            <?php endif; ?>
            <?php if($order->tax_amount): ?>
            <div class="flex justify-between mb-2">
                <span>Tax:</span>
                <span><?php echo e(number_format($order->tax_amount)); ?>₫</span>
            </div>
            <?php endif; ?>
            <div class="flex justify-between text-lg font-bold border-t pt-2">
                <span>Total:</span>
                <span><?php echo e(number_format($order->total_amount)); ?>₫</span>
            </div>
        </div>
        ...
        <div class="mt-6 flex gap-3">
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                Back to Orders
            </a>
        </div>
    </div>
