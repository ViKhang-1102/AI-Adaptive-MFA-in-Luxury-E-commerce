...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="mb-6">
        <a href="<?php echo e(route('seller.orders.index')); ?>" class="inline-flex items-center text-sm font-medium text-neutral-500 hover:text-primary transition-colors group">
                        ...
                        <div class="flex items-center justify-between group">
                            <div class="flex items-center gap-4 flex-1">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-neutral-500">Qty: <?php echo e($item->quantity); ?> x $<?php echo e(number_format($item->product_price ?? 0, 2)); ?></p>
                                </div>
                            </div>
                            
                            <div class="text-right flex flex-col items-end gap-2">
                                <span class="font-bold text-lg text-primary">$<?php echo e(number_format(($item->subtotal ?? (($item->product_price ?? 0) * $item->quantity)), 2)); ?></span>
                            </div>
                        </div>
                        <?php if(!$loop->last): ?>
