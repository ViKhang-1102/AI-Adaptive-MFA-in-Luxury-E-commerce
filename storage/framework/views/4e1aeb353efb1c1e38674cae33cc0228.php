    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-2">
            ...
            <div class="mb-6 text-2xl font-bold">
                ...
                <span class="text-red-600">$<?php echo e(number_format($product->getDiscountedPrice() / env('VND_PER_USD', 23000), 2)); ?></span>
                <span class="text-gray-400 line-through text-lg">$<?php echo e(number_format($product->price / env('VND_PER_USD', 23000), 2)); ?></span>
                <span class="text-red-600 bg-red-100 px-2 py-1 rounded text-sm ml-2">Save <?php echo e($product->discount_percent); ?>%</span>
                <?php else: ?>
                <span>$<?php echo e(number_format($product->price / env('VND_PER_USD', 23000), 2)); ?></span>
                <?php endif; ?>
            </div>
            ...
            <div class="bg-white rounded-lg shadow hover:shadow-lg transition overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <div class="flex justify-between items-center">
                        <span class="font-bold">$<?php echo e(number_format($related->getDiscountedPrice() / env('VND_PER_USD', 23000), 2)); ?></span>
