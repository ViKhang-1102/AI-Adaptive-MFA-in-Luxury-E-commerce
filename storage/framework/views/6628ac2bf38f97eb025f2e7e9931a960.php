    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow h-fit">
            ...
            <div class="space-y-2">
                ...
                <a href="<?php echo e(route('addresses.index')); ?>" class="block px-4 py-2 rounded hover:bg-gray-100">
                    My Addresses
                </a>
                <?php endif; ?>
            </div>
                ...
                <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="address" rows="3" 
                            class="w-full px-4 py-2 border rounded"><?php echo e(auth()->user()->address); ?></textarea>
                    </div>

                    <div>
                        <label class="block font-bold mb-2">Bio</label>
                        <textarea name="bio" rows="3" maxlength="500"
                            class="w-full px-4 py-2 border rounded"><?php echo e(auth()->user()->bio); ?></textarea>
                    </div>
