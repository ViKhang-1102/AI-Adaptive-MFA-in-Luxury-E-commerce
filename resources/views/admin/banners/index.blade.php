...
<div class="max-w-7xl mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('admin.banners.create') }}" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">+ Add Banner</a>
    </div>
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-3">
                            <a href="{{ route('admin.banners.edit', $banner) }}" class="text-blue-600 hover:underline text-sm">Edit</a>
                            <form method="POST" action="{{ route('admin.banners.destroy', $banner) }}" class="inline ml-3" onsubmit="return confirm('Are you sure?')">
                                @csrf @method('DELETE')
