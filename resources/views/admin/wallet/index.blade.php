...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white p-6 rounded-lg shadow">
            ...
            <h2 class="text-3xl font-bold text-blue-600">${{ number_format($totalBalance / env('VND_PER_USD', 23000), 2) }}</h2>
            <p class="text-gray-500 text-xs mt-2">Current funds in platform</p>
        </div>
        <div class="bg-white p-6 rounded-lg shadow">
            <p class="text-gray-600 text-sm mb-1">Total Seller Wallets</p>
            <h2 class="text-3xl font-bold text-green-600">${{ number_format($totalSellerWallets / env('VND_PER_USD', 23000), 2) }}</h2>
