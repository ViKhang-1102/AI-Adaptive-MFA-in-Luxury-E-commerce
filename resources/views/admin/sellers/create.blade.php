...
<div class="max-w-2xl mx-auto px-4 py-8">
    <div class="mb-6">
        <a href="{{ route('admin.sellers.index') }}" class="inline-flex items-center text-sm font-medium text-neutral-500 hover:text-primary transition-colors group">
    ...
    <div class="bg-white p-6 rounded-md-lg shadow-sm">
        <form action="{{ route('admin.sellers.store') }}" method="POST">
            ...
            <div class="flex gap-4">
                ...
                <a href="{{ route('admin.sellers.index') }}" class="px-6 py-2 bg-neutral-500 text-white rounded-md hover:bg-gray-600 font-semibold">
                    Cancel
                </a>
            </div>
        </form>
