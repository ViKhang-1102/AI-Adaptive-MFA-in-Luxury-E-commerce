        ...
        <form action="{{ route('admin.customers.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password_confirmation"
                    class="w-full px-4 py-2 border rounded-md @error('password_confirmation') border-red-500 @enderror" required>
            ...
            <div class="flex gap-4">
                ...
                <a href="{{ route('admin.customers.index') }}" class="px-6 py-2 bg-neutral-500 text-white rounded-md hover:bg-gray-600 font-semibold">
                    Cancel
                </a>
            </div>
        </form>
