                ...
                <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                    @if($product->hasDiscount())
                        <div class="flex items-center gap-3">
                            <span class="text-3xl font-bold text-red-600">${{ number_format($product->getDiscountedPrice() / env('VND_PER_USD', 23000), 2) }}</span>
                            <span class="text-xl text-gray-400 line-through">${{ number_format($product->price / env('VND_PER_USD', 23000), 2) }}</span>
                    ...
                    @else
                        <div class="text-3xl font-bold">${{ number_format($product->price / env('VND_PER_USD', 23000), 2) }}</div>
                    @endif
                </div>
