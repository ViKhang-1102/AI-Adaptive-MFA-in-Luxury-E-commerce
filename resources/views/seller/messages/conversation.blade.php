...
<div class="max-w-4xl mx-auto px-4 py-8">
    <div class="mb-6">
        <a href="{{ route('seller.messages.index') }}" class="inline-flex items-center text-sm font-medium text-neutral-500 hover:text-primary transition-colors group">
    ...
    <div class="bg-white p-6 rounded-md-lg shadow-sm">
        <h2 class="text-xl font-bold mb-4">Product: {{ $product->name }}</h2>
        <h3 class="text-lg mb-4">Customer: {{ $other->name }}</h3>
