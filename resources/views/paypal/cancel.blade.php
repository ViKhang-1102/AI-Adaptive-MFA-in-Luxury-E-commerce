...
<div class="min-h-screen bg-neutral-50 flex flex-col justify-center items-center py-12 sm:px-6 lg:px-8">
    <div class="max-w-xl w-full space-y-8 bg-white p-10 rounded-xl shadow-lg border-t-4 border-red-500">
        ...
        <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <a href="{{ route('cart.index') }}" class="flex-1 flex justify-center items-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-sm transition-all duration-200">
                <i class="fas fa-arrow-left mr-2 text-xs"></i> Back to My Cart
            </a>
            <a href="{{ route('home') }}" class="flex-1 flex justify-center items-center py-3 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all duration-200">
                Continue Shopping
            </a>
        </div>
        ...
        <div class="text-center pt-6">
            <p class="text-xs text-gray-400">
                Need help with your payment? <a href="{{ route('support.contact') }}" class="text-blue-500 hover:underline">Contact our support team</a>.
            </p>
        </div>
    </div>
</div>
