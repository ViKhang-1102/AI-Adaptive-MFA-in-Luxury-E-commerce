                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <span class="text-red-600 font-bold">${{ number_format($product->getDiscountedPrice() / env('VND_PER_USD', 23000), 2) }}</span>
                                <span class="text-gray-400 line-through text-sm">${{ number_format($product->price / env('VND_PER_USD', 23000), 2) }}</span>
                                @else
                                <span class="font-bold">${{ number_format($product->price / env('VND_PER_USD', 23000), 2) }}</span>
                                @endif
                            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a href="{{ route('products.show', $product) }}" class="bg-white rounded-lg shadow hover:shadow-lg transition overflow-hidden block text-decoration-none group">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-600 text-sm mb-2">{{ $product->seller->name }}</p>
                    <div class="flex justify-between items-center">
                        <span class="font-bold group-hover:text-blue-600">${{ number_format($product->getDiscountedPrice() / env('VND_PER_USD', 23000), 2) }}</span>
                        <span class="text-blue-600 group-hover:text-blue-800">
                            <i class="fas fa-arrow-right"></i>
                        </span>
                    </div>
