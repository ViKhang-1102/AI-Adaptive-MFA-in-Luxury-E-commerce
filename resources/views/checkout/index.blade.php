        ...
        <div class="bg-white p-6 rounded-lg shadow h-fit">
            ...
            <div class="space-y-4 mb-6">
                ...
                <div class="flex justify-between text-sm border-b pb-2">
                    ...
                    <span>${{ number_format(($item->product->getDiscountedPrice() * $item->quantity) / env('VND_PER_USD', 23000), 2) }}</span>
                </div>
                @endforeach
            </div>
            ...
            <div class="space-y-3 border-t pt-4">
                ...
                <div class="flex justify-between">
                    <span>Shipping:</span>
                    <span>${{ number_format($shippingFee / env('VND_PER_USD', 23000), 2) }}</span>
                </div>
                <div class="flex justify-between text-xl font-bold border-t pt-3">
                    <span>Total:</span>
                    <span>${{ number_format($total / env('VND_PER_USD', 23000), 2) }}</span>
                </div>
            </div>
