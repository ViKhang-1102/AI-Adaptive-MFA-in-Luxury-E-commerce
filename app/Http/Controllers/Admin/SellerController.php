                ...
                if (in_array($order->status, ['pending', 'review', 'confirmed', 'paid', 'processing'])) {
                    ...
                    if ($order->customer) {
                        \App\Models\OrderNotification::create([
                            ...
                            'message' => "Order #{$order->id} has been cancelled because the seller account was deleted by administration.",
                        ]);
                        ...
                        if ($firstItem && $firstItem->product_id) {
                            \App\Models\Message::create([
                                ...
                                'message' => "Order #{$order->id} was cancelled as the seller account was removed.",
                            ]);
                        }
                    }
                }
